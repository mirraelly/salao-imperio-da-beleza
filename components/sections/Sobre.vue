<template>
  <div class="py-8 px-4 md:px-0 lg:px-8 bg-black" id="sobre">
    <h1 class="text-[2rem] text-center text-[#ffd700] title-hero">
      Quem Somos
    </h1>
    <div>
      <div
        class="flex flex-col-reverse xl:flex-row items-center lg:items-stretch sm:flex-row w-full justify-center gap-8 lg:gap-20 mt-8 h-min max-w-[80rem]"
      >
        <div class="w-full md:w-1/2 flex flex-col gap-6 ladoA">
          ...
          <div class="w-[12rem] h-[2.5rem] flex">
            <p class="text-[1.5rem] md:text-[2rem] text-[#ffd600] assinatura">
              Rita de Kácia
            </p>
          </div>
        </div>
        <div class="w-full max-w-[20rem] md:w-1/3 ladoA">
          <div class="container w-full h-full">
            <div
              class="custom-card h-full relative bg-[#808080] p-[20px] text-center rounded-lg w-full overflow-hidden"
            >
              <img
                src="../../assets/images/rita-depe.jpeg"
                alt="Mulher pensativa"
                class="profile-image w-full h-full rounded-lg object-cover"
              />
              <div
